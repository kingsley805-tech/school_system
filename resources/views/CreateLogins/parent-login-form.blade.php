      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="col-lg-12 stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title" style="background:rgb(9, 9, 9);color:white;padding:20px;border-radius:10px;width:22rem">Administration CreateLogins </h4>
                    ...
                    <table id="example" class="table table-sm table-striped table-bordered">
                      <thead style="background-color: aliceblue;">
                        <tr>
                          ...
                          <th  style='background: rgb(255, 30, 0);color:white'>
                            Action
                          </th>
           ...
           // alert(4)
            console.log(data)
              ...
              //  cell5.style.display = 'none'
                ...
                button.textContent = 'Create For Login Student';
                ...
                button.onclick = function(){
                    let IndexNumber= $(this).closest('tr').find('td:eq(1)').text();
                     window.location = `/admininistration/create/login/parent/${IndexNumber}`
                }
