...
@section('content')
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="row"style="border-radius: 10px; box-shadow: 3px 3px 3px #888888;background: rgb(255, 73, 1)">
                ...
                <div class="card-body">
                  ...
                  <div class="table-responsive pt-6">
                    <table id="example" class="table table-sm table-striped table-bordered">
                      <thead style="background-color: rgb(86, 88, 91);color:white">
                        <tr>
                      ...
                      <tbody>
                        ...
                        <tr  class="alert alert-waring" style="background:gb(192, 156, 156);color:whte">
                          ...
                          <td>
                            <button class="btn btn-sm btn-primay"><a href="/library/book/issue/{{$book->id}}" style="color: white;background:rgb(34, 32, 32);padding:10px;border-radius:20px;">Issue</a></button>
                           </td>
