      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="col-lg-12 stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title" style="background:rgb(9, 9, 9);color:white;padding:20px;border-radius:10px;width:18rem">Invoice Payment Page </h4>
            ...
            for(var x = 0; x < subjects.length; x++){
                ...
                button.onclick = function(){
                    ...
                    let InvoiceNumber = $(this).closest('tr').find('td:eq(7)').text()
                     window.location = `/account/payment/invoice/list/${InvoiceID}/${InvoiceNumber}`
                }
            }
        },
