...
@section('content')
              <div class="row">
                <form class="form-sample" action="{{route('expense/edit')}}" method="POST">
                  @csrf
                ...
                <div class="col-12 grid-margin"  style="overflow: scroll">
                  <div class="card">
                    <div class="card-body">
                      <h4 class="card-title"><i style="font-size: 25px;" class='bx bxs-user-badge' ></i> <strong>New Expenses Form</strong>
                      ...
                      <div class="row">
                        <div class="mb-3 col-12 col-md-3">
                          ...
                          <input type="text" id="Title" name="Title" class="form-control" placeholder="" value="{{$expense->Title}}"
                          required>
                        ...
                        <div class="mb-3 col-12 col-md-3">
                          ...
                          <input type="text" id="Amount" name="Amount"  class="form-control" value="{{$expense->Amount}}" required >
                        ...
                        <div class="mb-3 col-12 col-md-3">
                          ...
                          <input type="text" id="invoiceNumber" name="invoiceNumber"  class="form-control" placeholder="" value="{{$expense->invoiceNumber}}"  required >
                        ...
                        <div class="mb-3 col-12 col-md-3">
                            ...
                            <input type="text" id="id" name="id" class="form-control" placeholder="" value="{{$expense->id}}"  required readonly >
                            <span style="color: red">@error('id') {{$message}} @enderror</span>
                          </div>

                        <div class="mb-3 col-12 col-md-12">
                          <label class="form-label" for="address2"><span class="text-danger">*</span><strong>Note:</strong></label>
                          <input type="text" id="Note" name="Note" class="form-control" placeholder="Note" required value="{{$expense->Note}}" >
