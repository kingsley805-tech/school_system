        ...
        <div class="content-wrapper">
          ...
          <div class="row" style="border-radius: 10px; box-shadow: 5px 5px 5px #888888;background:#ea5f02">
            <div class="col-lg-12 stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Payment History - Session: 2022-2023 <a data-bs-toggle="modal" data-bs-target="#exampleModal" style="position: absolute;right:20px;text-decoration:none;"><i style="font-size: 20px;" class='bx bxs-user-plus' ></i> All Payment History</a></h4>
