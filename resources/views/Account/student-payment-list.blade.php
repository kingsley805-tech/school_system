      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="col-lg-12 stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title"style="background:rgb(9, 9, 9);color:white;padding:20px;border-radius:10px;width:17rem">Payment history </h4>
...
<script>
  ...
  const student = document.getElementById('student')
    ...
    document.getElementById('student').addEventListener('input', function(e){
        ...
        $.ajax({
        type: 'POST',
        url: '/account/payment/history/student',
        ContentType: 'application/json',
