      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="col-lg-12 stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title" style="background:rgb(9, 9, 9);color:white;padding:20px;border-radius:10px;width:18rem">Payment History Page</h4>
...
<script>
  ...
  const student = document.getElementById('student')
    ...
    document.getElementById('class').addEventListener('input', function(e){
        e.preventDefault()
        const classroom_id = (e.target.value).trim()
        document.getElementById('timeTableView').innerHTML  = ''
        $.ajax({
        type: 'POST',
        url: '/account/payment/history/class',
        ...
        //    alert(4)
            ...
            for(var x = 0; x < subjects.length; x++){
                ...
                Cell2.innerHTML = subjects[x].classroom
                Cell3.innerHTML = subjects[x].Description
                Cell4.innerHTML = subjects[x].payingAmount
                Cell5.innerHTML = subjects[x].PaymentDate
                cell6.innerHTML = subjects[x].receiver
