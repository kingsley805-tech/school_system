      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="col-lg-12 stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Student Invoice List<a href="" style="position: absolute;right:20px;text-decoration:none;"><i class='bx bxs-user-plus' >Invoice List</i> </a></h4>
                  ...
                  <div class="row g-3">
                    <div class="col-6">
                     ...
                     <div class="col-6">
                        ...
                        <select id="student" name="IndexNumber" class="form-control" required>
