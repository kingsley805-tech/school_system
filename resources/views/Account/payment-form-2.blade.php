...
@section('content')
      ...
      <form class="row g-3" action="{{route('/payment/invoices/items/create')}}" method="POST">
            ...
            <div class="col-12">
              ...
              <input type="text"  class="form-control" id="Description" name="Description"  value="{{$invoiceItem->Description}}" readonly>
              <span style="color: red">@error('Description') {{$message}} @enderror</span>
            </div>

        <div class="col-4">
          <label for="staticEmail2" class="visually"><b></b>Balance Due</label>
          <input type="text"  class="form-control" id="AmountPayable" name="AmountPayable"  value="{{$invoiceItem->Total}}" readonly>
          <span style="color: red">@error('FeeType') {{$message}} @enderror</span>
        </div>
          <div class="col-4">
            <label for="inputPassword2"><b>Amount been Paid</b></label>
            <input type="number" class="form-control" id="payingAmount" name="payingAmount" value="{{$invoiceItem->Total}}" readonly>
            <span style="color: red">@error('amount') {{$message}} @enderror</span>
          </div>

          <div class="col-4">
            <label for="inputPassword2"><b>Amount Left</b></label>
            <input type="number" class="form-control" id="amountLeft" name="amountLeft" value="{{$invoiceItem->Total}}" readonly>
            <span style="color: red">@error('amount') {{$message}} @enderror</span>
          </div>

          
          <div class="col-4">
            <label for="inputPassword2"><b>Payment Date</b></label>
          ...
          <div class="col-4">
            ...
            <div class="col-4" style="">
                <label for="inputPassword2"><b>Item ID</b></label>
                <input type="text" class="form-control" id="id" name="id" value="{{$invoiceItem->id}}" readonly>
