            ...
            <div class="card-body">
              <h4 class="card-title">Teachers | Administrator</h4>
                ...
                <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control form-control-lg" id="Address" name="Address" placeholder="Address" value="{{old('Address')}}"style='border:1px solid rgb(248, 128, 7)'>
                        <span style="color: red">@error('Address') {{$message}} @enderror</span>
                    </div>
                    <div class="form-group">
                        <input type="tel" class="form-control form-control-lg" id="Contact" name="Contact" placeholder="Contact" value="{{old('Contact')}}"style='border:1px solid rgb(248, 128, 7)'>
