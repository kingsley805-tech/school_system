          ...
          <div class="card">
            <div class="card-body">
              ...
              <div style="position: relative;" class="mb-5">
                <a href="/admin/academics/routine-create-page" style="position: absolute;right:20px; text-decoration:none; color:rgb(249, 246, 245);background:rgb(237, 105, 57);padding:10px;margin:-50px 0 0 0;border-radius:30px"><i class='bx bxs-user-plus' style="color: white"></i>Add New Routine</a>
              </div>
              ...
              <div class="table-responsive pt-6">
                <table id="example" class="table table-sm table-striped table-bordered">
                  <thead style="background-color: aliceblue;">
                    <tr>
                      <th style="background:rgb(237, 105, 57);color:white">
                        Class
                      </th>
                      <th style="background:rgb(237, 105, 57);color:white">
                        Section
