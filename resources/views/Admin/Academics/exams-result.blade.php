            ...
            <div class="text-center font-sans">
                ...
                <div id="report" class="mt-4 hidden md:block">
                  <div class="mt-4"style="margin-top: 1rem;">
                    ...
                    <p class="text-base font-semibold" style="font-size: 1rem; font-weight: 600;">Phone: <span class="font-normal" style="font-weight: normal;">0554440059</span> | <a href="" class="text-blue-400" style="color: rgb(237, 105, 57);">Email: school@rapidentrepreneurs.com</a></p>
                  ...
                  <div class="" style="display:flex; margin:0 0 0 12rem;">
                    <div style="margin:0 8rem 0 -8rem;">
                      <p class="text-base font-semibold" style="font-size: 1rem; font-weight: 600;">Student Name: <span class="font-normal" style="font-weight: normal;">Retest Student</span></p>
                      <p class="text-base font-semibold" style="font-size: 1rem; font-weight: 600;">Admission Number: <span class="font-normal" style="font-weight: normal;">RS00002</span></p>
                      <p class="text-base" style="font-size: 1rem;">Session:</p>
                    </div>
                
                    <div style="margin:0 0 0 12rem;">
                      <p class="text-base font-semibold" style="font-size: 1rem; font-weight: 600;">Class: <span class="font-normal" style="font-weight: normal;">JHS 3</span></p>
                      <span class="font-semibold" style="font-weight: bold;">Section <span class="font-normal" style="font-weight: normal;">A</span></span>
                      <p class="text-base" style="font-size: 1rem;">Roll Number: 2</p>
                      <p class="text-base font-semibold" style="font-size: 1rem; font-weight: 600;">Phone: <span class="font-normal" style="font-weight: normal;">+233 24 116 4088</span></p>
                    </div>
                  </div>
                  ...
                  <div class="p-4 border border-gray-300 rounded-lg" style="padding: 1rem; border: 1px solid #e2e8f0; border-radius: 0.375rem;">
                      ...
                      <table class="min-w-full" style="border-collapse: collapse; width: 100%;">
                        ...
                        <tbody style="background: #f3f4f6;">
                            <tr style="border: 1px solid #e5e7eb; border-left:1px solid #e5e7eb ;">
                                <td style="padding: 16px;border: 1px solid #e5e7eb; border-left:1px solid #e5e7eb ;font-weight: 700;">English</td>
                                <td style="padding: 16px;border: 1px solid #e5e7eb; border-left:1px solid #e5e7eb ;"></td>
                                <td style="padding: 16px;border: 1px solid #e5e7eb; border-left:1px solid #e5e7eb ;"></td>
                                <td style="padding: 16px;border: 1px solid #e5e7eb; border-left:1px solid #e5e7eb ;"></td>
                                <td style="padding: 16px;border: 1px solid #e5e7eb; border-left:1px solid #e5e7eb ;"></td>
                                <td style="padding: 16px;border: 1px solid #e5e7eb; border-left:1px solid #e5e7eb ;"></td>
                            ...
                            <tr style="border: 1px solid #e5e7eb; border-left:1px solid #e5e7eb ;">
                                <td style="padding: 16px;border: 1px solid #e5e7eb; border-left:1px solid #e5e7eb ;font-weight: 700;">Mathematics</td>
                                <td style="padding: 16px;border: 1px solid #e5e7eb; border-left:1px solid #e5e7eb ;"></td>
                                <td style="padding: 16px;border: 1px solid #e5e7eb; border-left:1px solid #e5e7eb ;"></td>
                                <td style="padding: 16px;border: 1px solid #e5e7eb; border-left:1px solid #e5e7eb ;"></td>
                                <td style="padding: 16px;border: 1px solid #e5e7eb; border-left:1px solid #e5e7eb ;"></td>
                            ...
                            <tr style="border: 1px solid #e5e7eb; border-left:1px solid #e5e7eb ;">
                                <td style="padding: 16px;border: 1px solid #e5e7eb; border-left:1px solid #e5e7eb ;font-weight: 700;">Int.Science</td>
                                <td style="padding: 16px;border: 1px solid #e5e7eb; border-left:1px solid #e5e7eb ;"></td>
                                <td style="padding: 16px;border: 1px solid #e5e7eb; border-left:1px solid #e5e7eb ;"></td>
                                <td style="padding: 16px;border: 1px solid #e5e7eb; border-left:1px solid #e5e7eb ;"></td>
                                <td style="padding: 16px;border: 1px solid #e5e7eb; border-left:1px solid #e5e7eb ;"></td>
                            ...
                            <tr style="border: 1px solid #e5e7eb; border-left:1px solid #e5e7eb ;">
                                <td style="padding: 16px;border: 1px solid #e5e7eb; border-left:1px solid #e5e7eb ;font-weight: 700;">Social Studies</td>
                                <td style="padding: 16px;border: 1px solid #e5e7eb; border-left:1px solid #e5e7eb ;"></td>
                                <td style="padding: 16px;border: 1px solid #e5e7eb; border-left:1px solid #e5e7eb ;"></td>
                                <td style="padding: 16px;border: 1px solid #e5e7eb; border-left:1px solid #e5e7eb ;"></td>
                                <td style="padding: 16px;border: 1px solid #e5e7eb; border-left:1px solid #e5e7eb ;"></td>
                            ...
                            <tr style="border: 1px solid #e5e7eb; border-left:1px solid #e5e7eb ;">
                                <td style="padding: 16px;border: 1px solid #e5e7eb; border-left:1px solid #e5e7eb ;font-weight: 700;">French</td>
                                <td style="padding: 16px;border: 1px solid #e5e7eb; border-left:1px solid #e5e7eb ;"></td>
                                <td style="padding: 16px;border: 1px solid #e5e7eb; border-left:1px solid #e5e7eb ;"></td>
                                <td style="padding: 16px;border: 1px solid #e5e7eb; border-left:1px solid #e5e7eb ;"></td>
                                <td style="padding: 16px;border: 1px solid #e5e7eb; border-left:1px solid #e5e7eb ;"></td>
                            ...
                            <tr style="border: 1px solid #e5e7eb; border-left:1px solid #e5e7eb ;">
                                <td style="padding: 16px;border: 1px solid #e5e7eb; border-left:1px solid #e5e7eb ;font-weight: 700;">B.D.T</td>
                                <td style="padding: 16px;border: 1px solid #e5e7eb; border-left:1px solid #e5e7eb ;"></td>
                                <td style="padding: 16px;border: 1px solid #e5e7eb; border-left:1px solid #e5e7eb ;"></td>
                                <td style="padding: 16px;border: 1px solid #e5e7eb; border-left:1px solid #e5e7eb ;"></td>
                                <td style="padding: 16px;border: 1px solid #e5e7eb; border-left:1px solid #e5e7eb ;"></td>
                            ...
                            <tr style="border: 1px solid #e5e7eb; border-left:1px solid #e5e7eb ;">
                                <td style="padding: 16px;border: 1px solid #e5e7eb; border-left:1px solid #e5e7eb ;font-weight: 700;">Physical Education</td>
                                <td style="padding: 16px;border: 1px solid #e5e7eb; border-left:1px solid #e5e7eb ;"></td>
                                <td style="padding: 16px;border: 1px solid #e5e7eb; border-left:1px solid #e5e7eb ;"></td>
                                <td style="padding: 16px;border: 1px solid #e5e7eb; border-left:1px solid #e5e7eb ;"></td>
                                <td style="padding: 16px;border: 1px solid #e5e7eb; border-left:1px solid #e5e7eb ;"></td>
                            ...
                            <tr style="border: 1px solid #e5e7eb; border-left:1px solid #e5e7eb ;">
                                <td style="padding: 16px;border: 1px solid #e5e7eb; border-left:1px solid #e5e7eb ;font-weight: 700;">R.M.E</td>
                                <td style="padding: 16px;border: 1px solid #e5e7eb; border-left:1px solid #e5e7eb ;"></td>
                                <td style="padding: 16px;border: 1px solid #e5e7eb; border-left:1px solid #e5e7eb ;"></td>
                                <td style="padding: 16px;border: 1px solid #e5e7eb; border-left:1px solid #e5e7eb ;"></td>
                                <td style="padding: 16px;border: 1px solid #e5e7eb; border-left:1px solid #e5e7eb ;"></td>
                            ...
                            <tr style="border: 1px solid #e5e7eb; border-left:1px solid #e5e7eb ;">
                                <td style="padding: 16px;border: 1px solid #e5e7eb; border-left:1px solid #e5e7eb ;font-weight: 700;">I.C.T</td>
                                <td style="padding: 16px;border: 1px solid #e5e7eb; border-left:1px solid #e5e7eb ;"></td>
                                <td style="padding: 16px;border: 1px solid #e5e7eb; border-left:1px solid #e5e7eb ;"></td>
                                <td style="padding: 16px;border: 1px solid #e5e7eb; border-left:1px solid #e5e7eb ;"></td>
                                <td style="padding: 16px;border: 1px solid #e5e7eb; border-left:1px solid #e5e7eb ;"></td>
                    ...
                    <div class="mt-4 hidden md:block space-y-3 md:flex flex-col md:flex-row space-x-20 items-center justify-center "style='display:flex;flex-direction:rows'>
                      ...
                      <div class="font-semibold">
                        ...
                        <p>PRINTING COST: .......................</p>
                        <p>P.T.A. GH¢: ..................................</p>
                        <p>Sports and Games GH¢: ........</p>
                        <p>Fees for next term:....................</p>
