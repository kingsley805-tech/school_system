            ...
            <div class="card-body">
              <h4 class="card-title">Subject | Academics </h4>
                ...
                <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                    ...
                    <div class="form-group">
                        <select class="form-control form-control-lg"  name="subject_type" id="subject_type"style='border:1px solid rgb(248, 128, 7)'>
                    ...
                    <div class="form-group">
                        <select class="form-control form-control-lg"  name="classroom" id="classroom"style='border:1px solid rgb(248, 128, 7)'>
