                    ...
                    <table id="example" class="table table-sm table-striped table-bordered">
                      ...
                      <tbody id="TableBodyDiv">
                        ...
                        <tr  class="alert alert-war[ning">
                          ...
                          @if($value->valNumber == 1)
                          <td>
                              <div class="btn-group">
                                  <button class="btn btn-sm btn-success"><a style="color:white">Present</a></button>
                              </div>
                          </td>
                      @else
                          <td>
                              <div class="btn-group">
                                  <button class="btn btn-sm btn-danger"><a style="color:white">Absent</a></button>
                              </div>
                          </td>
                      @endif
