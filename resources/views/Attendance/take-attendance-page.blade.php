      ...
      <br>
          ...
          <div class="row justify-content-between">
            ...
            <div class="col-auto">
              ...
              <button style="background:rgb(255, 72, 0);border-radius:7px;color:rgb(247, 242, 242);font-weight:900;width:10rem;height:3rem" type="button" class="" id="AttendanceBtn"><b><i class='bx bx-save' ></i>Take Attendance</b></button>
            </div>
          </div>
        </div>
        </div>
   ...
   <script>
    ...
    document.getElementById('AttendanceBtn').addEventListener('click', function(e){
        ...
        if(id === ''){
            ...
            window.location.href = `/attendance/take/form/${id}`
        }
